...
host = 'localhost'
port = '5432'
database = 'dbcentralized'
username = 'dbcentralized'
password = 'changeme'
query = 'SELECT * FROM core_visit'
...
# schedule.every(30).minutes.do(fetch_and_send_data)

#Schedule the task every minute
schedule.every().minute.do(fetch_and_send_data)
